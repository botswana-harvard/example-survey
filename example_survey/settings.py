"""
Django settings for example_survey project.
...
ROOT_URLCONF = 'example_survey.urls'
...
WSGI_APPLICATION = 'example_survey.wsgi.application'
...
STATIC_URL = '/static/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'example_survey', 'media')
